...
// Each shape: a kind ('circle' | 'square' | 'triangle' | 'hexagon'), a
// position, size, drift distance/duration, and rotation — purely
// decorative, ambient motion behind the headline.
const SHAPES = [
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(120deg, rgba(37,99,235,0.16), rgba(99,102,241,0.10), rgba(14,165,233,0.14), rgba(37,99,235,0.16))',
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(37,99,235,0.18) 0%, transparent 70%), radial-gradient(ellipse 60% 40% at 100% 90%, rgba(99,102,241,0.12) 0%, transparent 70%)',
        }}
        aria-hidden="true"
      />
